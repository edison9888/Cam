...
- (void) loadView {
    ...
    UIImage *backButtonImage = [UIImage imageNamed:@"close_btn.png"];
    UIImage *backButtonOnImage = [UIImage imageNamed:@"close_btn2.png"];
	...
	UIBarButtonItem *leftBarButtonItem = [[[UIBarButtonItem alloc] initWithCustomView:backButton] autorelease];
